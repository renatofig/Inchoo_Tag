...
class Inchoo_Tag_Block_Adminhtml_Tag_Edit extends Mage_Adminhtml_Block_Tag_Edit
{
    protected function _prepareLayout()
    {
        ...
        $this->unsetChild('store_switcher', $this->getLayout()->createBlock('adminhtml/tag_store_switcher'))
             ->unsetChild('accordion', $this->getLayout()->createBlock('adminhtml/tag_edit_accordion'));
